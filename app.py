...
MODEL_ID = "1bE_vT55cMRa6L6byzkhT8F_e_wE_BcZ1"
SCALER_ID = "1jzxXuMwemOl8PCCzjkFUR9luEH2bBOCN"
...
median_income = st.number_input("Median income", min_value=0.0, value=8.3)
...
# These numeric codes match LabelEncoder's alphabetical order
# for the categories used in your notebook.
ocean_codes = {
    "<1H OCEAN": 0,
    "INLAND": 1,
    "ISLAND": 2,
...
if st.button("Estimate house value"):
